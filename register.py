...
class Register:
    def __init__(self,root):
        ...
        self.bg=Image.open(r"C:\Users\NIDHI\OneDrive\Desktop\Face_Recognition_System\Images_GUI\backg.png")
        self.bg=self.bg.resize((1366,768),Image.LANCZOS)
        self.photobg=ImageTk.PhotoImage(self.bg)

        lb1_bg=Label(self.root,image=self.photobg)
        lb1_bg.place(x=0,y=0, relwidth=1,relheight=1)

        frame= Frame(self.root )
        frame.place(x=180,y=80,width=900,height=580)
        

        # img1=Image.open(r"C:\Users\NIDHI\OneDrive\Desktop\Face_Recognition_System\Images_GUI\reg1.png")
        ...
        get_str = Label(frame,text="Registration",font=("times new roman",30,"bold"),fg="brown" )
        get_str.place(x=350,y=130)

        #label1 
        fname =lb1= Label(frame,text="First Name:",font=("times new roman",15,"bold"),fg="brown" )
        ...
        #label2 
        lname =lb1= Label(frame,text="Last Name:",font=("times new roman",15,"bold"),fg="brown" )
        ...
        #label1 
        cnum =lb1= Label(frame,text="Contact No:",font=("times new roman",15,"bold"),fg="brown" )
        ...
        #label2 
        email =lb1= Label(frame,text="Email:",font=("times new roman",15,"bold"),fg="brown" )
        ...
        #label1 
        ssq =lb1= Label(frame,text="Select Security Question:",font=("times new roman",15,"bold"),fg="brown" )
        ...
        #label2 
        sa =lb1= Label(frame,text="Security Answer:",font=("times new roman",15,"bold"),fg="brown" )
        ...
        #label1 
        pwd =lb1= Label(frame,text="Password:",font=("times new roman",15,"bold"),fg="brown" )
        ...
        #label2 
        cpwd =lb1= Label(frame,text="Confirm Password:",font=("times new roman",15,"bold"),fg="brown" )
        ...
        # Checkbutton
        checkbtn = Checkbutton(frame,variable=self.var_check,text="I Agree the Terms & Conditions",font=("times new roman",13,"bold"),fg="brown" )
        checkbtn.place(x=100,y=480,width=270)


        # Creating Button Register
        loginbtn=Button(frame,command=self.reg,text="Register",font=("times new roman",15,"bold"),bd=0,relief=RIDGE,fg="#fff",bg="purple",activeforeground="purple",activebackground="white")
        loginbtn.place(x=103,y=510,width=270,height=35)

        # Creating Button Login
        loginbtn=Button(frame,text="Login",font=("times new roman",15,"bold"),bd=0,relief=RIDGE,fg="#fff",bg="purple",activeforeground="purple",activebackground="white")
