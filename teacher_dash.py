...
from teacher_std import Teacher_Student
...
class Teacher_dash:
    def __init__(self,root):
           ...
           #  logo  
            ...
            std_b1 = Button(bg_img,command=self.teacher_student,image=self.std_img1,cursor="hand2",bd=0)
            ...
            # tra_b1.place(x=250,y=548,width=265,height=125)
            ...
            pho_b1.place(x=550,y=548,width=265,height=125)
            ...
            dev_b1.place(x=850, y=548, width=265, height=125)
...
# ==================Functions Buttons=====================
    def teacher_student(self):
        ...
        self.app=Teacher_Student(self.new_window)
