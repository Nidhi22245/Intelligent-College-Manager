...
class MyAttendance:
    ...
    def __init__(self,root):
        ...
        # Right Label Frame 
        right_frame = LabelFrame(main_frame,bd=2,bg="white",relief=RIDGE,text="Attendance",font=("verdana",12,"bold"),fg="purple")
        ...
        table_frame.place(x=3,y=15,width=775,height=450)
        ...
        #create table 
        self.attendanceReport = ttk.Treeview(table_frame,column=("ID","subject","Teacher_name","Time","Date","Attend"),xscrollcommand=scroll_x.set,yscrollcommand=scroll_y.set)
        ...
        self.attendanceReport.heading("Teacher_name",text="Teacher Name")
        ...
        self.attendanceReport.column("subject",width=100)
        self.attendanceReport.column("Teacher_name",width=100)
    ...
    #Update button
    #     del_btn=Button(right_frame,command=self.update_data,text="Update",width=12,font=("verdana",12,"bold"),fg="purple",bg="white")
    #     del_btn.grid(row=0,column=1,padx=6,pady=10,sticky=W)
    # #Update button
    #     del_btn=Button(right_frame,command=self.delete_data,text="Delete",width=12,font=("verdana",12,"bold"),fg="purple",bg="white")
    ...
    #                 mycursor.execute("update stdattendance set std_id=%s,std_subject=%s,std_name=%s,std_time=%s,std_date=%s,std_attendance=%s where std_id=%s",( 
    #                 self.var_id.get(),
    #                 self.var_roll.get(),
    #                 self.var_name.get(),
    #                 self.var_time.get(),
    ...
    #             udate = i[4]
    #             uattend = i[5]
    #             qury = "INSERT INTO stdattendance(std_id, std_subject, std_name, std_time, std_date, std_attendance) VALUES(%s,%s,%s,%s,%s,%s)"
