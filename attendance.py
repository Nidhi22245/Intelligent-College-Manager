...
class Attendance:
    ...
    def __init__(self,root):
        ...
        # Creating Frame 
        main_frame = Frame(bg_img,bd=2 ) #bd mean border 
        main_frame.place(x=5,y=90,width=1355,height=550)
        ...
        #Student id
        studentId_label = Label(left_frame,text="Std-ID:",font=("verdana",12,"bold") ,fg="black" )
        ...
        #Student Roll
        student_roll_label = Label(left_frame,text="Roll.No:",font=("verdana",12,"bold") ,fg="black" )
        ...
        #Studnet Name
        student_name_label = Label(left_frame,text="Std-Name:",font=("verdana",12,"bold") ,fg="black" )
        ...
        #Department
        # dep_label = Label(left_frame,text="Department:",font=("verdana",12,"bold") ,fg="black" )
        ...
        #time
        time_label = Label(left_frame,text="Time:",font=("verdana",12,"bold") ,fg="black" )
        ...
        #Date 
        date_label = Label(left_frame,text="Date:",font=("verdana",12,"bold") ,fg="black" )
        ...
        #Attendance
        student_attend_label = Label(left_frame,text="Attend-status:",font=("verdana",12,"bold") ,fg="black" )
        ...
        #Import button
        save_btn=Button(btn_frame,command=self.importCsv,text="Import CSV",width=12,font=("verdana",12,"bold"),bg="darkblue" ,fg="white" )
        save_btn.grid(row=0,column=0,padx=6,pady=10,sticky=W)

        #Export button
        update_btn=Button(btn_frame,command=self.exportCsv,text="Export CSV",width=12,font=("verdana",12,"bold"),bg="orange" ,fg="white" )
        update_btn.grid(row=0,column=1,padx=6,pady=8,sticky=W)

        #Update button
        del_btn=Button(btn_frame,command=self.action,text="Update",width=12,font=("verdana",12,"bold"),bg="blue" ,fg="white" )
        del_btn.grid(row=0,column=2,padx=6,pady=10,sticky=W)

        #reset button
        reset_btn=Button(btn_frame,command=self.reset_data,text="Reset",width=12,font=("verdana",12,"bold"),bg="purple" ,fg="white" )
    ...
    #Update button
        del_btn=Button(right_frame,command=self.update_data,text="Update",width=12,font=("verdana",12,"bold"),bg="blue" ,fg="white" )
        del_btn.grid(row=0,column=1,padx=6,pady=10,sticky=W)
    #Delete button
        del_btn=Button(right_frame,command=self.delete_data,text="Delete",width=12,font=("verdana",12,"bold") ,bg="darkblue",fg="white" )
        del_btn.grid(row=0,column=2,padx=6,pady=10,sticky=W)
    ...
    def exportCsv(self):
        try:
            ...
            with open(fln,mode="w",newline="") as myfile:
                ...
                messagebox.showinfo("Successful","Exported Data Successfully!")
        except Exception as es:
                messagebox.showerror("Error",f"Due to: {str(es)}",parent=self.root)    
